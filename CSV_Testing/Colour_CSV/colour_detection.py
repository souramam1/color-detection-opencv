...
class ColorDetectionWithROI:
    ...
    def process_frame(self):
        """Capture and process frame for color detection."""
    ...
    def detect_and_draw_contours(self, image_frame, masks, roi):
        """Detect contours of colors and draw them on the frame."""
        if roi:
            x, y, w, h = roi
    ...
    def get_smoothed_count(self, color):
        """Get the smoothed color count using a moving average."""
    ...
    def show_result(self, image_frame):
        """Display the result frame with detected regions and counts."""
